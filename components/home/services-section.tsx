...
const services = [
  {
    ...
    description:
      "Comienza tu dia con un desayuno preparado con ingredientes frescos de la region, servido en la comodidad de tu cabaña.",
  },
  {
    icon: Heart,
  ...
  },
  {
    ...
    description:
      "Celebra tu cumpleaños en un entorno magico. Nos encargamos de la decoracion para que solo te preocupes por disfrutar.",
  },
]
