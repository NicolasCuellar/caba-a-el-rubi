    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      {useVideo ? (
        ...
        <Image
          ...
          alt="Vista panoramica de La Cabaña El Rubi en Villarestrepo"
          fill
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        <p className="animate-fade-in-up-delay-2 mb-10 max-w-xl text-base font-light leading-relaxed text-primary-foreground/85 md:text-lg">
          {"Cabañas acogedoras rodeadas de naturaleza, montanas y aire puro. Tu refugio ideal para descansar."}
        </p>
        <div className="animate-fade-in-up-delay-3 flex flex-col items-center gap-4 sm:flex-row">
          ...
          >
            <Link href="/reserva">Conocer Cabañas</Link>
          </Button>
        </div>
      </div>
