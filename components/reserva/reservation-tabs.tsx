...
export function ReservationTabs() {
  ...
  useEffect(() => {
    const syncTabWithHash = () => {
      setTab(window.location.hash === "#formulario-pasadia" ? "pasadia" : "alojamiento")
    }
  ...
  useEffect(() => {
    if (tab !== "pasadia" || window.location.hash !== "#formulario-pasadia") return

    const scrollToPasadiaForm = () => {
    ...
    const frame = window.requestAnimationFrame(() => {
      window.requestAnimationFrame(scrollToPasadiaForm)
    })
