...
const services = [
  ...
  {
    icon: PartyPopper,
    title: "Decoracion de Cumpleaños",
    price: "$80.000",
    description:
      "Decoracion festiva con globos, letreros personalizados y detalles tematicos. Hacemos tu celebracion especial en la montaña.",
  },
  {
    icon: ShoppingBasket,
    ...
    price: "$85.000",
    description:
      "Disfruta de un picnic especial en medio de la naturaleza con productos locales.",
  },
  {
    icon: PawPrint,
    title: "Pet Friendly",
