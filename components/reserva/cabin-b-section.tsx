...
const tabs = [
  {
    ...
    label: "General",
    content:
      "Nuestra Cabaña zafiro es la opcion perfecta para grupos de amigos o familias. Con espacios amplios, balcon con vista al valle y una sala de estar comoda, tendras todo lo necesario para un fin de semana inolvidable.",
  },
  {
    key: "servicios",
    label: "Servicios",
    content:
      "Incluye Wi-Fi, sala equipada, baño privado, ropa de cama, toallas y tambien puedes agregar servicios adicionales como desayunos o decoraciones especiales.",
  },
  {
    key: "entorno",
    label: "Entorno",
    content:
      "Rodeada de naturaleza, con senderos para caminatas, aves exoticas y la tranquilidad absoluta de Villarestrepo. una posicion privilegiada en el  valle y las montanas.",
  },
]
          ...
          <div className="grid grid-cols-2 gap-3 lg:order-2">
            ...
            <div className="relative overflow-hidden rounded-xl">
              <Image
                ...
                alt="Cabaña B interior sala de estar"
                width={400}
                height={300}
