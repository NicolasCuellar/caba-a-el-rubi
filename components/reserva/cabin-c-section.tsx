...
const features = [
  ...
  { icon: Coffee, label: "sala de estar" },
  { icon: Bath, label: "baño privado" },
  { icon: TreePine, label: "ventanal panoramico" },
  { icon: Flame, label: "Cafetera" },
]

const story = [
  {
    title: "Despierta con vistas",
    text: "Cada mañana te reciben las montanas a traves de los ventanales. El canto de los pajaros y el aroma a cafe fresco crean el despertar perfecto.",
  },
  {
    title: "Comodidad sin limites",
    text: "Disfruta de la mejor de las vistas en nuestras cabañas que te dejara sin palabras.",
  },
  {
    title: "Momentos inolvidables",
      text: "Desde cenas bajo las estrellas hasta caminatas al amanecer, esta cabaña es el escenario perfecto para crear recuerdos que duraran toda la vida.",
  },
]
...
export function CabinCSection() {
  ...
  return (
    <section id="cabana-c" ref={sectionRef} className="overflow-hidden">
      ...
      <div className="relative flex min-h-[58vh] items-center justify-center md:min-h-[62vh]">
        <Image
          src="/images/rosa.jpeg"
          alt="Cabaña esmeralda premium con ventanales y vista a la montana"
          fill
        ...
        <div className="relative z-10 flex flex-col items-center px-6 text-center">
          <div className="mb-4 flex items-center gap-2 rounded-full border border-primary-foreground/30 bg-primary-foreground/10 px-4 py-1.5 backdrop-blur-sm">
            ...
            <span className="text-xs font-semibold text-primary-foreground">Cabaña Premium</span>
          </div>
          ...
          <p className="max-w-md text-base font-light text-primary-foreground/80">
            Nuestra experiencia mas exclusiva. Naturaleza y confort en perfecta armonia.
          </p>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="grid grid-cols-2 gap-3">
              <div className="relative col-span-1 row-span-2 overflow-hidden rounded-xl">
                <Image
                  src="/images/ermeralda01.jpeg"
                  alt="Cabaña C jacuzzi con vista"
                  fill
              ...
              <div className="relative overflow-hidden rounded-xl">
                <Image
                  src="/images/esmeralda 3.jpeg"
                  alt="Cabaña C sala de estar"
                  width={400}
                  height={250}
              ...
              <div className="relative overflow-hidden rounded-xl">
                <Image
                  src="/images/esmeralda1.jpeg"
                  alt="Cabaña C dormitorio"
                  width={400}
                  height={250}
                  className="h-full w-full object-cover"
                />
            ...
            <div className="flex flex-col justify-center">
              ...
              >
                <Link href="#formulario">Reservar esta cabaña</Link>
              </Button>
            </div>
          </div>
        </div>
